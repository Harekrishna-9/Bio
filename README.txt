...
PWA ADMIN APP
- iPhone Home Screen install supported
- Standalone app mode
- Apple touch icon included
- Offline fallback page included
- Service worker uses network-first for app code to reduce stale GitHub Pages cache

iPHONE INSTALL:
Safari -> open /Bio/admin.html -> Share -> Add to Home Screen -> Add
