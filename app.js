...
async function loadSettings(){
  ...
  if(!error && data){
    ...
    if($("#publicVerified"))$("#publicVerified").style.display=data.verified===false?"none":"";
    const loc=document.querySelector(".meta-row span:first-child"); if(loc)loc.textContent="📍 "+(data.location_text||"India");
    const profileImg=document.querySelector("img.avatar"); if(profileImg&&data.profile_photo_url)profileImg.src=data.profile_photo_url;
